    ...
    <div id="services" className="py-16 bg-white">
      <div className="container mx-auto max-w-6xl px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4 w-full lg:w-2/3 mx-auto text-center">
            Explore our wide range of services designed to assist you in various aspects like financial planning, immigration, and support for international students.
          </p>
        </div>
